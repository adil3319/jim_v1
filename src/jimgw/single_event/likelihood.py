...
class HeterodynedTransientLikelihoodFD(TransientLikelihoodFD):
    ...
    def maximize_likelihood(
        ...
        print(" maximize likelihood :",dict(zip(parameter_names, best_fit)),best_fit,summary["final_log_prob"],jnp.argmin(summary["final_log_prob"]),min(summary["final_log_prob"]))
